...
class RestaurantServiceImplTest {
	...
	@Test
	void testGetCuisine() {
		when(service.getCuisine(any(Integer.class))).thenReturn(new Cuisine(1, "Test Cuisine 1", 11, 1));
		assertTrue(new Cuisine(1, "Test Cuisine 1", 11, 1).equals(service.getCuisine(1)));
	}
